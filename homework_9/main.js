...
div1.innerText = 'Hello from main.js';
div1.style.fontSize = '32px';
div1.style.color = 'cyan';
document.body.appendChild(div1);

let cloneDiv1 = div1.cloneNode(true);
...
for (const element of coursesAndDurationArray) {
    ...
    div2.innerText = `Title: ${element.title}
    Duration:${element.monthDuration}`;
...
for (const element of coursesAndDurationArray) {
    ...
    p.innerText = `Duration: ${element.monthDuration}`;

    h1.style.margin = '15px 0 0 0';
...
for (const simpson of simpsons) {
    ...
    sur.innerText = `Surname - ${simpson.surname}`;
    ...
    div.append(name,sur,age,info,img);
    document.body.appendChild(div);
...
for (const element of coursesArray) {
    ...
    titleDiv.innerText = `Title: ${element.title}`;
    monthDiv.innerText = `Month Duration: ${element.monthDuration}`;
    hourDiv.innerText = `Hour Duration: ${element.hourDuration}`;
    ...
    moduleText.innerText = 'Ми вивчаємо :';
    moduleDiv.appendChild(moduleText);
    moduleDiv.appendChild(ul);
    mainDiv.append(titleDiv,monthDiv,hourDiv,moduleDiv);
